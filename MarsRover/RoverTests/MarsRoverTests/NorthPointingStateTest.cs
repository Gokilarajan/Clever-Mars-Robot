...
{
    /// <summary>
    ///This is a test class for NorthPointingTest and is intended
    ///to contain all NorthPointingTest Unit Tests
    ///</summary>
    [TestClass()]
    public class NorthPointingStateTest
    {
        ...
        public void TestInitiallize()
        {
            ...
            IPosition _roverWestPosition = Position.CreateNew(1, 2, Enum_Direction.Direction_N);
            _roverInstance = new MarsRover(_roverWestPosition, _plateauInstance, _initialState);
        }

        private RoverState CreateTarget()
        {
            return new NorthPointingState();
        }
        /// <summary>
        ///A test for Handle method to do Left Navigation
        ///</summary>
        [TestMethod()]
        public void NorthPointingState_Handle_NavigationLeft_ExpectWest()
        {
            //Arrange
        ...
        ///</summary>
        [TestMethod()]
        public void NorthPointingState_Handle_NavigationRight_ExpectEast()
        {
            //Arrange
            PrivateObject _marsRover = new PrivateObject(_roverInstance);
        ...
        ///</summary>
        [TestMethod()]
        public void NorthPointingState_Handle_NavigationMove_ExpectIncrementinYaxis()
        {
            //Arrange
            PrivateObject _marsRover = new PrivateObject(_roverInstance);
            ...
            target.Handle(_roverInstance);
            //Assert
            Assert.AreEqual<int>(3, _roverInstance.CurrentPosition.Yaxis);
        }
    }
}

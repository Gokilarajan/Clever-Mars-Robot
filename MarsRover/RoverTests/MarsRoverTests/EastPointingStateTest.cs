...
{
    /// <summary>
    ///This is a test class for EastPointingStateTest and is intended
    ///to contain all EastPointingStateTest Unit Tests
    ///</summary>
    [TestClass()]
    public class EastPointingStateTest
    {
        ...
        ///</summary>
        [TestMethod()]
        public void EastPointingState_Handle_NavigationLeft_ExpectNorth()
        {
            //Arrange
        ...
        /// <summary>
        ///A test for Handle method for Right Navigation
        ///</summary>
        [TestMethod()]
        public void EastPointingState_Handle_NavigationRight_ExpectSouth()
        {
            //Arrange
            PrivateObject _marsRover = new PrivateObject(_roverInstance);
        ...
        ///</summary>
        [TestMethod()]
        public void EastPointingState_Handle_NavigationMove_ExpectIncrementinXaxis()
        {
            //Arrange
            PrivateObject _marsRover = new PrivateObject(_roverInstance);
            ...
            target.Handle(_roverInstance);
            //Assert
            Assert.AreEqual<int>(2, _roverInstance.CurrentPosition.Xaxis);
        }
    }
}
